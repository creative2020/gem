...
/////////////////////////////////////////////////////////////////////////// GEM: tab
    ...
    $options[] = array(
		'name' => __('GEM Settings', 'options_framework_theme'),
		'type' => 'heading');
    
    $options[] = array(
		'name' => __('Company', 'options_framework_theme'),
		'desc' => __('Enter company name', 'options_framework_theme'),
		'id' => 'gem_co_name',
		'std' => 'RD Co Name',
		'type' => 'text');
    
    $options[] = array(
		'name' => __('Company phone', 'options_framework_theme'),
		'desc' => __('Enter company phone number', 'options_framework_theme'),
		'id' => 'gem_co_phone',
		'std' => '123-456-7890',
		'type' => 'text');
    ...
    $options[] = array(
		...
		'desc' => __('Upload your icon', 'options_framework_theme'),
		'id' => 'gem_icon',
        'std' => '/wp-content/uploads/icon-gem-pink-252.png',
		'type' => 'upload');
